            ...
            if (isset($anEvent['RRULE']) && $anEvent['RRULE'] != '') {
                ...
                switch ($frequency) {
                    ...
                    case 'WEEKLY':
                        ...
                        // Step through weeks
                        while ($week_recurring_timestamp <= $until && $count_of_recurrences < $max_recurrences) {
                            $count_of_recurrences++;
